...
--------------------------------------------------------------------------------
-- |
-- Module      :  Payasan.Models.Chords.Base
...
-- | Potentially should be octave agnostic...
--
data Chord = Chord 
    { chord_root   :: Pitch
...
addN                :: Int -> Interval -> Chord -> Chord
addN n inv          = chordF (IM.insert n inv)



deleteN             :: Int -> Chord -> Chord
deleteN n           = chordF (IM.delete n)
...
dim_5               :: Chord -> Chord
dim_5               = no_5 . addN 5 diminished_fifth

aug_5               :: Chord -> Chord
aug_5               = no_5 . addN 5 augmented_fifth

min_7               :: Chord -> Chord
min_7               = addN 7 minor_seventh

maj_7               :: Chord -> Chord
maj_7               = addN 7 major_seventh


dim_7               :: Chord -> Chord
dim_7               = addN 7 diminished_seventh


-- no3 . add_perfect_fourth 
sus_4               :: Chord -> Chord
sus_4               = no_3 . addN 4 perfect_fourth


dim_9               :: Chord -> Chord
dim_9               = addN 7 minor_seventh . addN 9 diminished_ninth


-- Don't implement Pachet's @ninth@ instead implement min9 and maj9

min_9               :: Chord -> Chord
min_9               = addN 7 minor_seventh . addN 9 minor_ninth

maj_9               :: Chord -> Chord
maj_9               = addN 7 major_seventh . addN 9 major_ninth
